...
关于L约束，本博客也出现过多次，可以参考的文章有[《深度学习中的Lipschitz约束：泛化与生成模型》](/archives/6051)、[《BN究竟起了什么作用？一个闭门造车的分析》](/archives/6992)。值得提醒的是，不同的场景可能会需要不同的L约束，比如有时候我们要假设模型输出关于输入满足L约束，有时候我们要假设模型输出关于参数满足L约束，而上面假设的是模型loss的梯度关于参数满足L约束。

如果条件$\eqref{eq:l-cond}$成立，那么很多优化问题都将大大简化。因为我们可以证明（证明过程可参考[这里](/archives/6992#%E6%A0%B8%E5%BF%83%E4%B8%8D%E7%AD%89%E5%BC%8F)）  
...
[![论文观察到损失函数的光滑程度与梯度模长呈“线性相关”关系](/usr/uploads/2020/06/2551061567.png)](/usr/uploads/2020/06/2551061567.png "点击查看原图")
...
_**转载到请包括本文地址：**<https://spaces.ac.cn/archives/7469>_
...
苏剑林. (Jun. 05, 2020). 《为什么梯度裁剪能加速训练过程？一个简明的分析 》[Blog post]. Retrieved from <https://spaces.ac.cn/archives/7469>
...
year={2020},  
month={Jun},  
url={\url{https://spaces.ac.cn/archives/7469}},  
} 
