...
date: 
source: https://spaces.ac.cn/archives/9181
...
在[《生成扩散模型漫谈（三）：DDPM = 贝叶斯 + 去噪》](/archives/9164)中，我们提到过该文章所介绍的推导跟DDIM紧密相关。具体来说，文章的推导路线可以简单归纳如下：  
...
[![DDIM的实验结果，显示噪声越小，加速后的生成效果越好](/usr/uploads/2022/07/724883953.jpg)](/usr/uploads/2022/07/724883953.jpg "点击查看原图")
...
[![DDIM随机向量的插值生成效果](/usr/uploads/2022/07/1078989049.jpg)](/usr/uploads/2022/07/1078989049.jpg "点击查看原图")
...
以DDPM的默认参数$T=1000$、$\alpha_t = \sqrt{1 - \frac{0.02t}{T}}$为例，我们重复[《生成扩散模型漫谈（一）：DDPM = 拆楼 + 建楼》](/archives/9119)所做的估计  
...
_**转载到请包括本文地址：**<https://spaces.ac.cn/archives/9181>_
