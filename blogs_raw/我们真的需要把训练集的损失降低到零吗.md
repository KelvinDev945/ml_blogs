...
tags: 优化, 深度学习, 损失函数, 泛化, 生成模型
status: pending
---

# 我们真的需要把训练集的损失降低到零吗？

**原文链接**: [https://spaces.ac.cn/archives/7643](https://spaces.ac.cn/archives/7643)
...
[![左图：不加Flooding的训练示意图；右图：加了Flooding的训练示意图](/usr/uploads/2020/07/2776542712.png)](/usr/uploads/2020/07/2776542712.png "点击查看原图")
...
[![Flooding实验结果。第三行的F就是表示Flooding，带红色勾的列都是加了Flooding的。](/usr/uploads/2020/08/1387058552.png)](/usr/uploads/2020/08/1387058552.png "点击查看原图")
...
本质上来讲，这跟往参数里边加入随机扰动、对抗训练等也没什么差别，只不过这里是保证了损失足够小后再加扰动。读者可以参考[《泛化性乱弹：从随机噪声、梯度惩罚到虚拟对抗训练》](/archives/7466)了解相关内容，也可以参考“圣经”《深度学习》第二部分第七章的“正则化”一节。
...
> 注：读者[@xx205](/archives/7643#comment-14142)提供了参考文献[《Backstitch: Counteracting Finite-sample Bias via Negative Steps》](http://www.danielpovey.com/files/2017_interspeech_backstitch.pdf)，里边指出这种做法在语音识别上是有效的，所以笔者的上述说法可能也不尽完善，请读者自行测试甄别。再次感谢读者读者[@xx205](/archives/7643#comment-14142)提供的资料。

## 文章小结 #

本文简单介绍了ICML 2020一篇论文提出的“到一定程度后就梯度上升”的训练策略，并给出了自己的推导和理解，结果显示它相当于对参数的梯度惩罚，而梯度惩罚也是常见的正则化手段之一。

_**转载到请包括本文地址：**<https://spaces.ac.cn/archives/7643>_
...
苏剑林. (Jul. 31, 2020). 《我们真的需要把训练集的损失降低到零吗？ 》[Blog post]. Retrieved from <https://spaces.ac.cn/archives/7643>
...
year={2020},  
month={Jul},  
url={\url{https://spaces.ac.cn/archives/7643}},  
} 
