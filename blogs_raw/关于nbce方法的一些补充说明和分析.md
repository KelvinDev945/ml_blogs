...
**原文链接**: [https://spaces.ac.cn/archives/9632](https://spaces.ac.cn/archives/9632)

**发布日期**: 

---

上周在[《NBCE：使用朴素贝叶斯扩展LLM的Context处理长度》](/archives/9617)中，我们介绍了一种基于朴素贝叶斯来扩展LLM的Context长度的方案NBCE（Naive Bayes-based Context Extension）。由于它有着即插即用、模型无关、不用微调等优点，也获得了一些读者的认可，总的来说目前大家反馈的测试效果还算可以。
...
_**转载到请包括本文地址：**<https://spaces.ac.cn/archives/9632>_
