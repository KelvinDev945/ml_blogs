...
**原文链接**: [https://spaces.ac.cn/archives/9907](https://spaces.ac.cn/archives/9907)
...
> 
> 2、目前只支持Arxiv作为论文源， _同步Arxiv的最新一天的论文列表_ ，所以刷Cool Papers基本上能等价于刷Arxiv，未来可能会接入其他论文源，比如OpenReview，这个看后面的使用情况和反馈再做计划；
> 
...
_**转载到请包括本文地址：**<https://spaces.ac.cn/archives/9907>_
...
苏剑林. (Dec. 25, 2023). 《写了个刷论文的辅助网站：Cool Papers 》[Blog post]. Retrieved from <https://spaces.ac.cn/archives/9907>
...
year={2023},  
month={Dec},  
url={\url{https://spaces.ac.cn/archives/9907}},  
} 
