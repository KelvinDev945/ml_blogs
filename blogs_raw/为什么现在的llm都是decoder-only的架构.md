...
date: 2023-03-17
tags: 分析, 语言模型, 文本生成, attention, 生成模型, Transformer, GPT, BERT, T5, 矩阵秩, Causal Attention
status: completed
tags_reviewed: true
---
...
4. **2020 - GPT-3（OpenAI）**：
   - Decoder-only架构
   - 175B参数，惊艳的few-shot能力
   - 奠定Decoder-only在LLM的主导地位

5. **2022 - PaLM（Google）**：
   - Decoder-only架构（Google也转向）
   - 540B参数，使用Pathways系统

6. **2023 - LLaMA/GPT-4**：
   - Decoder-only成为事实标准
   - 开源社区全面拥抱Decoder-only
