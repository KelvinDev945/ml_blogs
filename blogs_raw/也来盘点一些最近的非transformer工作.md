...
tags: 模型, 优化, 语言模型, attention, 生成模型
status: pending
---

# 也来盘点一些最近的非Transformer工作

**原文链接**: [https://spaces.ac.cn/archives/8431](https://spaces.ac.cn/archives/8431)
...
在之前的博客[《Google新作Synthesizer：我们还不够了解自注意力》](/archives/7430)中，我们已经对Synthesizer做了简单的解读。撇开缩放因子不说，那么Attention的运算可以分解为  
...
[![Synthesizer的“预训练+微调”实验结果。实验的baseline是T5，其中“R”即为Random模式，相当于MLP。](/usr/uploads/2021/05/121862092.png)](/usr/uploads/2021/05/121862092.png "点击查看原图")
...
[![MLP-Mixer的部分实验结果](/usr/uploads/2021/05/565072315.png)](/usr/uploads/2021/05/565072315.png "点击查看原图")
...
[![不管有无预训练，CNN都体现出了自己的优势](/usr/uploads/2021/05/2449574520.png)](/usr/uploads/2021/05/2449574520.png "点击查看原图")

不管有无预训练，CNN都体现出了自己的优势

这篇论文给我们的主要启发是：预训练改进与模型改进不应该混为一谈，预训练技术本身往往能给各种模型都带来提升，不应该一提到预训练就想到Transformer，也不应该只把预训练跟Transformer结合。事实上，笔者之前也比较喜欢CNN，曾通过“膨胀门卷积（[DGCNN](/search/DGCNN/)）”的设计在多个任务上取得不错的效果，而这篇论文则再次肯定了CNN的价值。不过尽管如此，笔者可能依然不会投入主要精力转向CNN的研究。
...
[![FNet的“预训练+微调”实验结果](/usr/uploads/2021/05/2861720516.png)](/usr/uploads/2021/05/2861720516.png "点击查看原图")

FNet的“预训练+微调”实验结果

[![FNet的Long-Range Arena实验结果](/usr/uploads/2021/05/144925274.png)](/usr/uploads/2021/05/144925274.png "点击查看原图")
...
[![gMLP,aMLP的NLP部分实验结果](/usr/uploads/2021/05/3943322046.png)](/usr/uploads/2021/05/3943322046.png "点击查看原图")
...
_**转载到请包括本文地址：**<https://spaces.ac.cn/archives/8431>_
